...
const GlobalState = ({ children }) => {
  ...
  function addPostSubmitHandler(e) {
    ...
    setAddPostInput('')
    // FIX THIS!
    setPostData([...postData, { id: Date.now(), username: currLoggedIn.username, fullname: currLoggedIn.fullname, text: addPostInput, img: currLoggedIn.img, nice: 0, nope: 0, likes: [], isLiked: false, dislikes: [], isDisliked: false, comments: [] }])
